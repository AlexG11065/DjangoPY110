...
from .views import products_view, shop_view, products_page_view, cart_view, cart_del_view, cart_add_view, \
    coupon_check_view, cart_buy_now_view, cart_remove_view
